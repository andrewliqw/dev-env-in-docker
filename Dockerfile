...
ENV PATH /usr/local/node7.9.0/bin:$PATH

RUN /usr/local/node7.9.0/bin/npm config set prefix /usr/local/node7.9.0 && /usr/local/node7.9.0/bin/npm install -g npm@latest
